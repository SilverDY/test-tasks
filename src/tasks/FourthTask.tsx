...
type StudentDict = any;
type TeacherDict = any;
...
export const FourthTask: React.FC = () => {
  // return <div>Look at the code </div>
  return <div>
    <h1>Look at the code in your IDE to solve the task</h1>

    <h2>Teacher</h2>
    <pre>{JSON.stringify(t1, null, 4)}</pre>

    <h2>Director</h2>
    <pre>{JSON.stringify(d1, null, 4)}</pre>
  </div>
}